	...
	public function get_is_child_theme() {
		...
		if ( ! $is_child_theme ) {
			$result['recommendation'] = sprintf(
				...
				_x( 'If you want to modify the source code of your theme, we recommend using a <a href="%s">child theme</a>.', 'System Info', 't42-content-protector' ),
