...
let isThisSafari = (Browser.toLowerCase().includes('safari') && !Browser.toLowerCase().includes('chrome'));
...
var isEnabledForBrowser = (isChrome || isSafari || isIEWin7 || true) && !isMobile;
