...
if (! defined('WPW_AUTO_POSTER_VERSION')) {
    define('WPW_AUTO_POSTER_VERSION', '5.0'); //version of plugin
}
...
if (! defined('WPW_AUTO_POSTER_INSTA_APP_METHOD_ID')) {
    define('WPW_AUTO_POSTER_INSTA_APP_METHOD_ID', '4071144333111775'); // Insta FACEBOOK APP ID
}
if (! defined('WPW_AUTO_POSTER_INSTA_APP_METHOD_SECRET')) {
    define('WPW_AUTO_POSTER_INSTA_APP_METHOD_SECRET', 'ebf17438e572c9dbd1d51a18091114bf'); // Insta APP SECRET
}
...
function wpw_auto_poster_wpweb_updater()
{
    ...
    $WpwebAutoPosterUpdateChecker = new WpwebPluginUpdateChecker(
        WPWEB_UPD_DOMAIN . '/Updates/SAP/license-info.php',
        __FILE__,
