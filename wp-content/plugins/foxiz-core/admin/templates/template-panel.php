...
<div class="rb-panel-wrap">
	<div class="rb-panel-header">
		<div class="rb-panel-heading">
			<h1><?php echo esc_html__( 'Welcome to', 'foxiz-core' ) . ' ' . '<strong>' . wp_get_theme()->Name . ' </strong>'; ?></h1>
		...
		<div class="rb-inner">
			<?php if ( empty( $is_activated ) ) : ?>
				<div class="rb-activate-header">
					<h2><i class="dashicons-before dashicons-admin-network"></i><?php echo sprintf( esc_html__( 'Activate %s', 'foxiz-core' ), wp_get_theme()->Name ) ?></h2>
				...
				<div class="rb-activate-form">
					<form method="post" action="" id="rb-register-theme-form">
						...
						<div class="rb-panel-input">
							...
							<span class="rb-error-info is-hidden"><i class="dashicons-info-outline dashicons-before"></i></span>
						</div>
						<div class="rb-panel-input">
						...
						<div class="rb-panel-submit">
							...
							<span class="rb-loading is-hidden"><i class="dashicons dashicons-update"></i></span>
			...
			<?php else : ?>
				<div class="rb-activate-header is-activated">
					<h2>
						<i class="dashicons-before dashicons-admin-network"></i><?php echo sprintf( esc_html__( '%s is Activated', 'foxiz-core' ), wp_get_theme()->Name ) ?>
					</h2>
