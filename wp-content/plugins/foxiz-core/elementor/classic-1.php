...
class Classic_1 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Foxiz - Classic (Standard)', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options'     => Options::columns_dropdown( array( 0, 1, 2, 3 ) ),
				'default'     => '0',
			)
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			'content_width', array(
				...
				'devices'     => array( 'desktop', 'tablet', 'mobile' ),
				'selectors'   => array( '{{WRAPPER}} .p-wrap' => '--content-width: {{VALUE}}px;' ),
			)
		);
		$this->end_controls_section();
		$this->start_controls_section(
