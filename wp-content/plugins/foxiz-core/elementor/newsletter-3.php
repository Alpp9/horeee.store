...
class Newsletter_3 extends Widget_Base {
	...
	public function get_title() {
		...
		return esc_html__( 'Foxiz - Sidebar Newsletter', 'foxiz-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'        => Controls_Manager::NUMBER,
				'selectors'   => array( '{{WRAPPER}} .newsletter-sb-featured img' => 'max-width: {{VALUE}}px;' )
			)
		);
		$this->add_responsive_control(
		...
		$this->add_responsive_control(
			'inner_padding', array(
				...
				'devices'     => array( 'desktop', 'tablet', 'mobile' ),
				'selectors'   => array( '{{WRAPPER}} .newsletter-sb-inner' => 'padding: {{VALUE}}px;' ),
			)
		);
		$this->end_controls_section();
	}
