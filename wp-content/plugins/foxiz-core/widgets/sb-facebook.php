...
if ( ! class_exists( 'Foxiz_W_Facebook', false ) ) :
	class Foxiz_W_Facebook extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Widget Facebook', 'foxiz-core' ), array(
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display the Facebook Like box in the sidebars.', 'foxiz-core' )
			) );
		}
