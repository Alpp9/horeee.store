...
if ( ! class_exists( 'Foxiz_W_Instagram', false ) ) :
	class Foxiz_W_Instagram extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Widget Instagram', 'foxiz-core' ), array(
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display a grid of instagram images in the sidebars.', 'foxiz-core' )
			) );
		}
		...
		function form( $instance ) {
			...
			foxiz_create_widget_textarea_field( array(
				...
				<div class="sb-instagram-grid">
					...
					<?php if ( ! empty( $instance['footer_intro'] ) ) : ?>
						<div class="grid-footer">
							<a href="<?php echo esc_url( $instance['footer_url'] ); ?>" target="_blank" rel="noopener nofollow"><?php echo wp_kses( $instance['footer_intro'], array(
									'a'      => array(
										'href'  => array(),
										'title' => array()
									),
		...
		function foxiz_data_instagram_token( $settings = array() ) {
