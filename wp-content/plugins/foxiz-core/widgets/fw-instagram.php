...
if ( ! class_exists( 'Foxiz_Fw_Instagram', false ) ) :
	class Foxiz_Fw_Instagram extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Fw Instagram', 'foxiz-core' ), array(
		...
		function form( $instance ) {
			...
			foxiz_create_widget_text_field( array(
				...
				'description' => esc_html__( 'This setting will only apply to the default grid layout.', 'foxiz-core' ),
								...
								<div class="instagram-box">
									...
									<div class="box-content">
										...
										if ( ! empty( $image['comments'] ) ) : ?>
											<span class="comments"><i class="rbi rbi-comment"></i><?php echo esc_html( $image['comments'] ); ?></span>
										<?php endif; ?>
									</div>
								</div>
							</div>
		...
		function foxiz_data_fw_instagram_token( $settings = array() ) {
