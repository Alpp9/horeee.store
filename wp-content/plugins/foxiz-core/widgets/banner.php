...
if ( ! class_exists( 'Foxiz_FW_Banner', false ) ) :
	class Foxiz_FW_Banner extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Widget Banner', 'foxiz-core' ), array(
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display banner with text and background image in the sidebars.', 'foxiz-core' )
			) );
		}
		...
		function form( $instance ) {
			...
			foxiz_create_widget_select_field( array(
				...
				'desc'    => esc_html__( 'Text Select a text color scheme for this block.', 'foxiz-core' ),
				'options' => array(
