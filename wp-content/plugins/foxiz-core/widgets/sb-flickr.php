...
if ( ! class_exists( 'Foxiz_W_Flickr', false ) ) :
	class Foxiz_W_Flickr extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Widget Flickr Grid', 'foxiz-core' ), array(
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display a grid of Flickr images in the sidebars.', 'foxiz-core' )
			) );
		}
		...
		function foxiz_data_flickr( $settings = array() ) {
