...
if ( ! class_exists( 'Foxiz_W_Social_Icon', false ) ) :
	class Foxiz_W_Social_Icon extends WP_Widget {
		...
		function __construct() {
			...
			parent::__construct( $this->widgetID, esc_html__( 'Foxiz - Widget Social Icons/About', 'foxiz-core' ), array(
				'classname'   => $this->widgetID,
				'description' => esc_html__( '[Sidebar Widget] Display about me information and social icons in the sidebars.', 'foxiz-core' )
			) );
		}
		...
		function widget( $args, $instance ) {
			...
			<div class="about-content-wrap">
				...
				<div class="<?php echo esc_attr( $social_class_name ); ?>">
					<?php echo foxiz_get_social_list( $data_social, $instance['new_tab'] ); ?>
				</div>
			</div>
