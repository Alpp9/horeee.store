...
if ( ! function_exists( 'foxiz_render_single_standard_4' ) ) {
	function foxiz_render_single_standard_4() {
		...
		$category_style_without_bg = array(
			'text',
			'text,big',
			'border',
			'border,big',
		...
		if ( ! empty( $entry_category ) && in_array( $entry_category, $category_style_without_bg ) ) {
                ...
                <div class="rb-container edge-padding">
                    <div class="single-header-inner">
                        <div class="s-feat-holder">
							...
							<?php endif; ?>
							<?php the_post_thumbnail( $crop_size, array( 'class' => 'featured-img' ) ); ?>
                        </div>
